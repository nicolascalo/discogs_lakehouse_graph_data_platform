...
def create_spark_session(
    app_name: str, endpoint: str, access_key: str, secret_key: str, uc_uri:str, uc_token:str, bucket:str, catalog:str|None=None
) -> SparkSession:
    ...
    builder = (
        ...
        .config("spark.sql.catalog.uc.token", uc_token)
        .config("spark.sql.catalog.uc.warehouse", f"s3a://{bucket}/")
